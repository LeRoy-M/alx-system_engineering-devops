0. Simply matching School [0-simply_match_school.rb] >> Ruby script that accepts one argument and passes it to a regular expression matching method that matches "School", using the project instructions
